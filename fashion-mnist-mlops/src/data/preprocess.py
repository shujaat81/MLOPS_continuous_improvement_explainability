...
def prepare_data_for_modeling(x_train, y_train, x_test, y_test, normalize=True, 
                             reshape_for_cnn=False, one_hot_encode=False):
    """
    ...
    # Normalize the data
    if normalize:
        x_train_prep, x_test_prep = normalize_images(x_train_prep, x_test_prep, method='simple')
...
if __name__ == "__main__":
    ...
    x_train_prep, y_train_prep, x_test_prep, y_test_prep = prepare_data_for_modeling(
        x_train, y_train, x_test, y_test, normalize=True, reshape_for_cnn=True, one_hot_encode=True
    )
