...
def plot_class_distribution(y, class_names=None, title=None, figsize=(10, 6), 
                           save_path=None):
    """
...
def plot_sample_images(x, y, class_names=None, samples_per_class=5, figsize=(15, 10), 
                      save_path=None):
    """
    ...
    for i, class_idx in enumerate(unique_classes):
        ...
        selected_indices = np.random.choice(indices, size=min(samples_per_class, len(indices)), replace=False)
...
def plot_correlation_matrix(df, method='spearman', figsize=(14, 12), max_features=100, 
                           save_path=None):
    """
...
if __name__ == "__main__":
    ...
    if config['visualizations']['sample_images']['enabled']:
        plot_sample_images(
            ...
            y_train, 
            class_names=class_names,
            samples_per_class=config['visualizations']['sample_images']['samples_per_class'],
